...
/**
 * @brief HTTP请求结构
 * @details 请求报文格式：  请求行 － 通用信息头 － 请求头 － 实体头 － 报文主体
 */
class HttpRequest {
public:
    /// HTTP请求的智能指针
...
/**
 * @brief HTTP响应结构体
 * @details 响应报文格式    状态行 － 通用信息头 － 响应头 － 实体头 － 报文主体
 */
class HttpResponse {
public:
    /// HTTP响应结构智能指针
